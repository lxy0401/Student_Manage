    ...
    <script type="text/javascript">
        ...
        function deleteStudent() {
            ...
            $.messager.confirm("系统提示", "您确认要删掉这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("${basePath}/studentDelete", {delIds: ids}, function (result) {
                        if (result.success) {
        ...
        function openStudentModifyDialog() {
            ...
            $("#fm").form("load", row);
            url = "${basePath}/studentSave?stuId=" + row.stuId;
        }
    </script>
</head>
<body style="margin: 5px;">
<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true" url="${basePath}/studentList" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    ...
    <div>&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo" size="10"/>
        ...
        <input class="easyui-combobox" id="s_gradeId" name="s_gradeId" size="10"
               data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'${basePath}/gradeComboList'"/>
